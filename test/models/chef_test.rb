...
class ChefTest < ActiveSupport::TestCase
  ...
  # end
  def setup
    @chef = Chef.new(chefname: "sabir", email: "sabir@gmail.com", 
  ...
  test "should reject invalid addresses" do
    invalid_emails = %w[user@example rehmat@gmail,com rehmat.name@gmail. john@bar+foo.com]
  ...
  test "email should be case unique and case insensitive" do
  ...
  test "email should be lower case before hitting db" do
    mixed_email ="ReHmAtUlLAh@Gmail.com"
